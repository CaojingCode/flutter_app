...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case TopArticleBeanEntity:
			...
			return topArticleBeanDataFromJson(data as TopArticleBeanData, json) as T;			case BannerBaenEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case TopArticleBeanEntity:
			...
			return topArticleBeanDataToJson(data as TopArticleBeanData);			case BannerBaenEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'TopArticleBeanEntity':
			...
			return TopArticleBeanData().fromJson(json);			case 'BannerBaenEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'TopArticleBeanEntity':
			...
			return List<TopArticleBeanData>();			case 'BannerBaenEntity':
