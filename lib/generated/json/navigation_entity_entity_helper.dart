...
navigationEntityEntityFromJson(NavigationEntityEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<NavigationEntityData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new NavigationEntityData().fromJson(v));
		});
	}
...
Map<String, dynamic> navigationEntityEntityToJson(NavigationEntityEntity entity) {
...
navigationEntityDataFromJson(NavigationEntityData data, Map<String, dynamic> json) {
	if (json['articles'] != null) {
		data.articles = new List<NavigationEntityDataArticle>();
		(json['articles'] as List).forEach((v) {
			data.articles.add(new NavigationEntityDataArticle().fromJson(v));
		});
	}
	if (json['cid'] != null) {
...
navigationEntityDataArticleFromJson(NavigationEntityDataArticle data, Map<String, dynamic> json) {
...
Map<String, dynamic> navigationEntityDataArticleToJson(NavigationEntityDataArticle entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
