...
topArticleBeanEntityFromJson(TopArticleBeanEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<TopArticleBeanData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new TopArticleBeanData().fromJson(v));
		});
	}
...
Map<String, dynamic> topArticleBeanEntityToJson(TopArticleBeanEntity entity) {
...
topArticleBeanDataFromJson(TopArticleBeanData data, Map<String, dynamic> json) {
...
Map<String, dynamic> topArticleBeanDataToJson(TopArticleBeanData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
